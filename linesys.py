...
>>>>>>> b0ed63d91150591ca4faa73f3addfbacc6b044fa
...
class LinearSystem(object):
    ...
    def multiply_coefficient_and_row(self, coefficient, row):
        ...
        new_normal_vector = n.timescalar(coefficient)

        new_constant_term = k * coefficient

        self[row] = Plane(normal_vector = Vector(new_normal_vector), constant_term = new_constant_term)
...
>>>>>>> b0ed63d91150591ca4faa73f3addfbacc6b044fa
    ...
    def compute_triangular_form(self):
        ...
        for i in range(num_equations):
            while j<num_variables:
                ...
                if c.is_near_zero():
                    swap_succeeded = system.swap_with_row_below_non_zero_coefficient_if_able(i,j)
    ...
    def scale_rows_to_make_coffecient_one(self,row,col):
        n = self[row].normal_vector
    ...
    def compute_rref(self):
        ...
        for i in range(num_equations)[::-1]:
            ...
            if j < 0:
                continue
            tf.scale_rows_to_make_coffecient_one(i,j)
    ...
    def compute_solution(self):
        try:
            ...
            # for parametrization use below, for infinite solution use above
...
# p1 = Plane(normal_vector=Vector(['5.862','1.178','-10.366']), constant_term='-8.5')
...
# s = LinearSystem([p3,p4,p5])

# r1 = s.compute_solution()
